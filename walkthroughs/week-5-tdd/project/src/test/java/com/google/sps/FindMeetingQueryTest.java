...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredExceptOptionalAllDayBusy() {
    // Ignore optional attandee's schedule if it deletes all options for mandatory attandees
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |-------------C---------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredEvenOptionalPartialBusy() {
    // Take optional attandee's schedule in account
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void notEnoughRoomIfConsiderOptional() {
    // There is not enough room if consider optional attandee's schedule.
    //
    // Events  : |--A--|     |----A----|
    // Optional:       |-B-|
    // Day     : |---------------------|
  ...
  @Test
  public void noMandatoryOptionalWithNoGap() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
